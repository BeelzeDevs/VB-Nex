...
Sheets("Master").Select
    ...
    For x = 0 To 70
            ...
            If (StrComp("1", ActiveCell.Offset(x, 0).Value, 0) = 0) Then
                            ...
                            MatrizTv(1, 3, cantelementos(1)) = ActiveCell.Offset(0, -19).Value 'Englis
                            MatrizTv(1, 4, cantelementos(1)) = ActiveCell.Offset(0, -18).Value 'Spanish
                            'MatrizTv(1, 5, cantelementos(1)) = "placa pared" 'IMAGEN BORRAR LUEGO, PROTOTIPO DE PRUEBA
                            
                            MatrizTv(1, 5, cantelementos(1)) = ActiveCell.Offset(0, -17).Value 'IMAGEN Por nro parte
                            MatrizTv(1, 6, cantelementos(1)) = ActiveCell.Offset(0, -10).Value  'Qty
                            ...
                            MatrizTv(1, 10, cantelementos(1)) = ActiveCell.Offset(0, -7).Value  'NW PER BOX
                            ...
                            MatrizTv(1, 17, cantelementos(1)) = ActiveCell.Offset(0, 1).Value  'LICENCIAS
                            
                         
                            
                            MatrizTv(1, 2, cantelementos(1)) = ActiveCell.Offset(0, -17).Value  'nro parte en lugar de Model

                            MatrizTv(1, 1, cantelementos(1)) = ActiveCell.Offset(0, -21).Value  'Brand
            ...
            If (StrComp("2", ActiveCell.Offset(x, 0).Value, 0) = 0) Then
                            Vbool(2) = True
                             ...
                             ActiveCell.Offset(x, 0).Activate
                            'lleno mi matriz con los elementos del batch numerado
                            MatrizTv(2, 3, cantelementos(2)) = ActiveCell.Offset(0, -19).Value 'Englis
                            MatrizTv(2, 4, cantelementos(2)) = ActiveCell.Offset(0, -18).Value 'Spanish
                            'MatrizTv(2, 5, cantelementos(2)) = "placa pared" 'IMAGEN BORRAR LUEGO, PROTOTIPO DE PRUEBA
                            
                            MatrizTv(2, 5, cantelementos(2)) = ActiveCell.Offset(0, -17).Value 'IMAGEN Por nro parte
                            MatrizTv(2, 6, cantelementos(2)) = ActiveCell.Offset(0, -10).Value  'Qty
                            ...
                            MatrizTv(2, 17, cantelementos(2)) = ActiveCell.Offset(0, 1).Value   'LICENCIAS
                            
                            MatrizTv(2, 2, cantelementos(2)) = ActiveCell.Offset(0, -17).Value  'Model
                            MatrizTv(2, 1, cantelementos(2)) = ActiveCell.Offset(0, -21).Value  'Brand
            ...
            If (StrComp("3", ActiveCell.Offset(x, 0).Value, 0) = 0) Then
                          ...
                          ActiveCell.Offset(x, 0).Activate
                            ...
                            MatrizTv(3, 3, cantelementos(3)) = ActiveCell.Offset(0, -19).Value 'Englis
                            MatrizTv(3, 4, cantelementos(3)) = ActiveCell.Offset(0, -18).Value 'Spanish
                            'MatrizTv(3, 5, cantelementos(3)) = "placa pared" 'IMAGEN BORRAR LUEGO, PROTOTIPO DE PRUEBA
                            
                            MatrizTv(2, 5, cantelementos(2)) = ActiveCell.Offset(0, -17).Value 'IMAGEN Por nro parte
                            MatrizTv(3, 6, cantelementos(3)) = ActiveCell.Offset(0, -10).Value  'Qty
                            ...
                            MatrizTv(3, 17, cantelementos(3)) = ActiveCell.Offset(0, 1).Value   'LICENCIAS
                            
                            MatrizTv(3, 2, cantelementos(3)) = ActiveCell.Offset(0, -17).Value  'Model
                            MatrizTv(3, 1, cantelementos(3)) = ActiveCell.Offset(0, -21).Value  'Brand
            ...
            If (StrComp("4", ActiveCell.Offset(x, 0).Value, 0) = 0) Then
                            ...
                            ActiveCell.Offset(x, 0).Activate
                            'lleno mi matriz con los elementos del batch numerado
                            MatrizTv(4, 3, cantelementos(4)) = ActiveCell.Offset(0, -19).Value 'Englis
                            MatrizTv(4, 4, cantelementos(4)) = ActiveCell.Offset(0, -18).Value 'Spanish
                            'MatrizTv(4, 5, cantelementos(4)) = "placa pared" 'IMAGEN BORRAR LUEGO, PROTOTIPO DE PRUEBA
                            
                            MatrizTv(4, 5, cantelementos(4)) = ActiveCell.Offset(0, -17).Value 'IMAGEN Por nro parte
                            MatrizTv(4, 6, cantelementos(4)) = ActiveCell.Offset(0, -10).Value  'Qty
                            ...
                            MatrizTv(4, 17, cantelementos(4)) = ActiveCell.Offset(0, 1).Value   'LICENCIAS
                            
                            
                            MatrizTv(4, 2, cantelementos(4)) = ActiveCell.Offset(0, -17).Value  'Model
                            MatrizTv(4, 1, cantelementos(4)) = ActiveCell.Offset(0, -21).Value  'Brand
            ...
            If (StrComp("5", ActiveCell.Offset(x, 0).Value, 0) = 0) Then
                        Vbool(5) = True
                          ...
                          ActiveCell.Offset(x, 0).Activate
                            'lleno mi matriz con los elementos del batch numerado
                            MatrizTv(5, 3, cantelementos(5)) = ActiveCell.Offset(0, -19).Value 'Englis
                            MatrizTv(5, 4, cantelementos(5)) = ActiveCell.Offset(0, -18).Value 'Spanish
                            'MatrizTv(5, 5, cantelementos(5)) = "placa pared" 'IMAGEN BORRAR LUEGO, PROTOTIPO DE PRUEBA
                            
                            MatrizTv(5, 5, cantelementos(5)) = ActiveCell.Offset(0, -17).Value 'IMAGEN Por nro parte
                            MatrizTv(5, 6, cantelementos(5)) = ActiveCell.Offset(0, -10).Value  'Qty
                            ...
                            MatrizTv(5, 17, cantelementos(5)) = ActiveCell.Offset(0, 1).Value   'LICENCIAS
                            
                            
                            MatrizTv(5, 2, cantelementos(5)) = ActiveCell.Offset(0, -17).Value  'Model
                            MatrizTv(5, 1, cantelementos(5)) = ActiveCell.Offset(0, -21).Value  'Brand
...
Application.CutCopyMode = False
    ...
    Range("R1").Select
    ActiveCell.FormulaR1C1 = "LICENCIAS"
    ...
    End With
    ' Ancho de imagen
    Columns("F:F").ColumnWidth = 14.09
    Columns("C:C").ColumnWidth = 14.36
